    ...
    void inputInformation(Scanner input) {
        ...
        do {
            ...
            try {
                ...
                id = Integer.parseUnsignedInt(strID);
                isIDValid = true;
        ...
        do {
            ...
            try {
                ...
                scores = new int[]{Integer.parseUnsignedInt(strScore)};
                isSCOREValid = true;
            } catch (Exception exception) {
            ...
            do {
                ...
                switch (option) {
                    case 1 -> {
                        ...
                        System.out.println("Successfully Added Student Information Into the System ......!");
                    }
                    case 2 -> {
